...
<!-- Your content -->
    ...
    <div class="bg-gradient-to-r from-blue-500 to-teal-500 text-white p-6 rounded-lg shadow-lg text-center mb-6">
        <h1 class="text-3xl font-semibold">
            Halo! <span class="font-extrabold">Penjelajah Kata!</span>, 
        </h1>
  ...
  <div class="mt-10 bg-white shadow rounded-lg overflow-x-auto">
        ...
        <table class="w-full">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-indigo-50 cursor-pointer" onclick="window.location='{{ route('buku.showBefore', $book->BUKU_ISBN) }}'">
